...
--   Tomar los dias del periodo cuando es empleado de tiempo completo y no se ha retirado.
select periodo_liquidacion
      ,sum(valor)                       costo
...
where a.tipo_presupuesto = 'E'
  ...
  --and n.periodo_liquidacion like '2015%'
...
group by pn.periodo_liquidacion
        ,pn.tipo_identificacion_empleado
        ,pn.numero_identificacion_empleado
;
)
